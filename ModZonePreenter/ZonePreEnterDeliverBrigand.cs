...
{
    public class ZonePreEnterDeliverBrigand : ZonePreEnterEvent
    {
        private QuestRiskyDeliver _Quest;
        ...
        {
            //"brigand_common_nonego_1_main",
            //"brigand_common_nego_1_main",
        };

        public ZonePreEnterDeliverBrigand(QuestRiskyDeliver q)
        {
            _Quest = q;
        }
        ...
        public override void Execute()
        {
            ...
            DramaWrapper.SetArgumentStrings(_Quest.Distribution.GetName(NameStyle.Full), Lang._currency(offerMoney.Num, showUnit: true), omakeGoods.GetName(NameStyle.Full));
